...
namespace WebApplication2.Controllers
{
    public class PokemonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Moves")] Pokemon pokemon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Moves")] Pokemon pokemon)
        {
            if (id != pokemon.Id)
            {
                return NotFound();
